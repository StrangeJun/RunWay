...
dependencies {
    ...
    // ─── Retrofit2 + OkHttp ───
    // JSON converter: Gson — annotation-free, zero boilerplate for Phase 1.
    // Swap to Kotlinx Serialization later if compile-time safety is needed.
